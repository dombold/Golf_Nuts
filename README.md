...
- **Tournaments** — create and manage multi-round tournaments with groups, invitations, and leaderboards; course search available during event creation; prize holes can be designated per nine (one Longest Drive on a par 5, up to two Nearest to Pin on par 3s); randomise teams button in the group builder; dashboard banner shows a quick-access button for pending invites or your next accepted event
