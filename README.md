...
- **Tournaments** — create and manage multi-round tournaments with groups, invitations, and leaderboards; course search available during event creation; prize holes (longest drive, nearest pin) can be assigned per hole; randomise teams button in the group builder; dashboard banner shows a quick-access button for pending invites or your next accepted event
